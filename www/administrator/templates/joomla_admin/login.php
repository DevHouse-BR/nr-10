...
<head>
<title><?php echo $mosConfig_sitename; ?> - Gerenciador de Conteúdo</title>
...
<div id="wrapper">
	<div id="header">
			<div id="joomla"><img src="templates/joomla_admin/images/header_text.png" width="283" height="38" alt="Gerenciador de Conteúdo" /></div>
	</div>
</div>
<div id="ctr" align="center">
	...
	<div class="login">
		...
		<div class="login-text">
			<div class="ctr"><img src="templates/joomla_admin/images/security.png" alt="Autenticação" /></div>
			<p>Bem vindo ao Gerenciador de conteúdo.</p>
...
<div class="footer" align="center">
	<div align="center">
   Desenvolvido por:
<a href="http://sistemasweb.nr-10.com/" target="_blank"><strong>Leonardo Lima de Vasconcellos</strong></a><br /><br />
	</div>
</div>
</body>
</html>