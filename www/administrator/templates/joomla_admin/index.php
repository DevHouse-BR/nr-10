...
<div id="wrapper">
	<div id="header">
			<div id="joomla">
			  <div >
			    <div><img src="templates/joomla_admin/images/header_text.png" alt="Gerenciador de Conteúdo" width="283" height="38" /></div>
			  </div>
			</div>
  </div>
</div>
	...
	<tr>
		<td align="center">
			...
			<div align="center" class="smallgrey">
				<br />
				Desenvolvido por <a href="http://sistemasweb.nr-10.com" target="_blank">Leonardo Lima de Vasconcellos</a>
			<br /> <br />
		  </div>			
			<?php
			if ( $mosConfig_debug ) {
